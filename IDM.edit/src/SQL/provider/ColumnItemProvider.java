		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SQLPackage.Literals.COLUMN__VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addForeign_keyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Column_foreign_key_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Column_foreign_key_feature", "_UI_Column_type"),
				 SQLPackage.Literals.COLUMN__FOREIGN_KEY,
				 true,
				 false,
				 true,
				 null,

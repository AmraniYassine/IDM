 ...
 * </p>
 * <ul>
 *   <li>{@link NoSQL.impl.CollectionImpl#getName <em>Name</em>}</li>
 *   <li>{@link NoSQL.impl.CollectionImpl#getDocument <em>Document</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CollectionImpl extends MinimalEObjectImpl.Container implements Collection {
	...
	protected EClass eStaticClass() {
		return NoSQLPackage.Literals.COLLECTION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NoSQLPackage.COLLECTION__NAME, oldName, name));
	}
	...
	public EList<Document> getDocument() {
		if (document == null) {
			document = new EObjectContainmentEList<Document>(Document.class, this, NoSQLPackage.COLLECTION__DOCUMENT);
		}
		return document;
	}

...
public class NoSQLPackageImpl extends EPackageImpl implements NoSQLPackage {
	...
	public static NoSQLPackage init() {
		...
		Object registeredNoSQLPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		NoSQLPackageImpl theNoSQLPackage = registeredNoSQLPackage instanceof NoSQLPackageImpl ? (NoSQLPackageImpl)registeredNoSQLPackage : new NoSQLPackageImpl();
	 ...
	 * @generated
	 */
	public EReference getDatabase_Collection() {
	 ...
	 * @generated
	 */
	public EReference getCollection_Document() {
	 ...
	 * @generated
	 */
	public EReference getDocument_Couple() {
	 ...
	 * @generated
	 */
	public EReference getValue_CoupleVal() {
	 ...
	 * @generated
	 */
	public EAttribute getCouple_Attribut() {
	 ...
	 * @generated
	 */
	public EReference getCouple_Value() {
	...
	public void createPackageContents() {
		...
		createEReference(databaseEClass, DATABASE__COLLECTION);

		collectionEClass = createEClass(COLLECTION);
		createEAttribute(collectionEClass, COLLECTION__NAME);
		createEReference(collectionEClass, COLLECTION__DOCUMENT);

		documentEClass = createEClass(DOCUMENT);
		createEAttribute(documentEClass, DOCUMENT__NAME);
		createEReference(documentEClass, DOCUMENT__COUPLE);

		valueEClass = createEClass(VALUE);
		createEReference(valueEClass, VALUE__COUPLE_VAL);

		atomicEClass = createEClass(ATOMIC);

		coupleEClass = createEClass(COUPLE);
		createEAttribute(coupleEClass, COUPLE__ATTRIBUT);
		createEReference(coupleEClass, COUPLE__VALUE);
	}
	...
	public void initializePackageContents() {
		...
		documentEClass.getESuperTypes().add(this.getValue());
		atomicEClass.getESuperTypes().add(this.getValue());
		...
		initEReference(getDatabase_Collection(), this.getCollection(), null, "collection", null, 1, -1, Database.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCollection_Document(), this.getDocument(), null, "document", null, 1, -1, Collection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getDocument_Couple(), this.getCouple(), null, "Couple", null, 1, -1, Document.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(valueEClass, Value.class, "Value", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getValue_CoupleVal(), this.getCouple(), this.getCouple_Value(), "CoupleVal", null, 1, -1, Value.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCouple_Attribut(), ecorePackage.getEString(), "attribut", null, 0, 1, Couple.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCouple_Value(), this.getValue(), this.getValue_CoupleVal(), "value", null, 1, 1, Couple.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
